...
Each capability is a self-contained plugin under `capabilities/`, containing its contract, implementation, documentation, and adapter files. The registry auto-discovers plugins at import time — no manual wiring is needed.
